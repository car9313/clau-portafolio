    ...
    <section ref={containerRef} className="py-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
          {/* Vertical line */}
          <motion.div
            className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-primaryColor/20"
            style={{ scaleY: scaleX }}
          />
          <motion.div
            className="sticky top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-primaryColor"
...
function TimelineEvent({
  ...
  return (
    ...
    >
      ...
      <div className="z-20">
        <div className="flex items-center justify-center w-8 h-8 bg-primaryColor rounded-full">
      ...
      <motion.div
        ...
        onClick={onToggle}
      >
        <div className="p-4 bg-background rounded-lg shadow-md border border-primaryColor/10">
          <span className="font-bold text-primaryColor">{event.year}</span>
